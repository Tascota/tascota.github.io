  ...
  links: [
    ...
    // 自定义一级下拉菜单示例：外部链接集合
    {
      ...
      children: [
        {
          name: "Bangumi",
          url: "https://bgm.tv/user/tascota",
          external: true, // 外部链接，新标签页打开
          icon: "",
        },
        {
          name: "Bilibili",
          url: "https://space.bilibili.com/361417173",
          external: true,
          // icon: "fa7-brands:bilibili",
        },
        {
          name: "Rednote",
          url: "https://www.xiaohongshu.com/user/profile/661e89fd000000000700580c",
          external: true,
          icon: "",
        },
        {
          name: "Zhihu",
          url: "https://www.zhihu.com/people/tascota-50",
          external: true,
          icon: "",
        },
        {
          name: "Twitter",
          url: "https://twitter.com/tascota",
          external: true,
          icon: "",
        },
      ],
