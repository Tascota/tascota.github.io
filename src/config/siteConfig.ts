...
export const siteConfig: SiteConfig = {
  title: "Cotaspace",
  subtitle: "Tascota 的网站",
  siteURL: "https://tascota.github.io/", // 请替换为你的站点URL，以斜杠结尾
  siteStartDate: "2024-08-04", // 站点开始运行日期，用于站点统计组件计算运行天数
  ...
  navbarTitle: {
    ...
    icon: "assets/home/cube.svg",
    // 网站Logo图片路径
    logo: "assets/home/cube.svg",
  },
  ...
  bangumi: {
    userId: "tascota", // 在此处设置你的Bangumi用户ID，可以设置为 "sai" 测试
    fetchOnDev: false, // 是否在开发环境下获取 Bangumi 数据（默认 false），获取前先执行 pnpm build 构建 json 文件
  },

  bilibili: {
    vmid: "361417173", // 在此处设置你的Bilibili用户ID (uid)，例如 "1129280784"
  ...
  banner: {
    ...
    src: {
      ...
      mobile: ["/assets/mobile-banner/1.jpg", "/assets/mobile-banner/2.jpg"], // 移动横幅图片
    }, // 使用本地横幅图片
    ...
    credit: {
      ...
      text: "Click for details.", // 要显示的来源文本
      url: "/about/#License", // （可选）原始艺术品或艺术家页面的 URL 链接
    },
